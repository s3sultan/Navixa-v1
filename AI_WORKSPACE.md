...
- انتظار مراجعة المستخدم لـDraft PR #212 قبل أي دمج أو نشر أو بدء مرحلة التخزين الدائم/استيراد مصادر الجامعة. التوصية الحالية: قبل D1 نبني عقد Source Ingestion واضحًا يحدد كيف تدخل البيانات الرسمية وPDF/الصورة/الاستيراد اليدوي، ثم نخزن فقط البيانات التي اجتازت التحقق السياقي.
