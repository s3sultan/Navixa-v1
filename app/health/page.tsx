...
export default function HealthPage(){
  ...
  return <main className="health-page" dir="rtl">
    <header className="health-topbar">
      ...
      <div className="health-identity"><span className="health-mark"><img src="/navixa-mark.webp" alt="" /></span><div><small>NAVIXA HEALTH</small><h1>مركز صحتي</h1><p>مساحة هادئة لجسم أكثر توازنًا ويوم أكثر نشاطًا.</p></div></div>
