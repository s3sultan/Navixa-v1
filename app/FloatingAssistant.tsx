...
export default function FloatingAssistant({ onAddTask }: { onAddTask: (title: string) => void }) {
  ...
  return <div className="floating-assistant" style={{ left: position.x, top: position.y }} dir="rtl">
    {open && <section className="assistant-panel" aria-label="مساعد NAVIXA">
      ...
      <aside className="assistant-learning-teaser" aria-label="NAVIXA Learning قريبًا"><span className="assistant-learning-icon" aria-hidden="true">Aa</span><div><small>من منظومة NAVIXA</small><b>NAVIXA Learning</b><p>مساحة لتعلّم الإنجليزية خطوة بخطوة.</p></div><em>قريبًا</em></aside>
