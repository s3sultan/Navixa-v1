  ...
  return <main className="today-page" dir="rtl">
    <FeatureAccessGate feature="صفحة يومي والإضافة السريعة">
      ...
      <header className="today-topbar">
        ...
        <nav aria-label="تنقل صفحة يومي"><Link href="/">الرئيسية</Link><Link className="today-alert-link" href="/#alerts">التنبيهات</Link><Link href="/account">حسابي</Link></nav>
      </header>
      ...
      <nav className="today-bottom-nav" aria-label="اختصارات الجوال"><Link href="/"><span>⌂</span><b>الرئيسية</b></Link><Link className="active" href="/today"><span>◷</span><b>يومي</b></Link><button type="button" onClick={() => openQuickAdd("task")} aria-label="إضافة سريعة"><span>＋</span><b>إضافة</b></button><Link href="/#alerts"><span>♢</span><b>التنبيهات</b></Link><Link href="/account"><span>⌾</span><b>حسابي</b></Link></nav>
