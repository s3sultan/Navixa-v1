  ...
  const requestBrowserNotifications=async()=>{
    ...
    try{
      ...
      try{
        ...
        setStatus(subscription.accountBound?"تم تفعيل Push وربطه بحسابك، ووصل اختبار الإرسال إلى الجهاز 🔔":"تم تفعيل Push على هذا الجهاز، ووصل اختبار الإرسال 🔔");
      }catch{
