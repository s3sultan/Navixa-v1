...
export async function POST(request:Request){
  ...
  try{
    ...
    await webpush.sendNotification({endpoint:row.endpoint,keys:{p256dh:row.p256dh,auth:row.auth}},JSON.stringify({kind:"general",title:"NAVIXA · اختبار Push",body:"وصل Push إلى جهازك بنجاح. التنبيهات جاهزة 🔔",tag:"navixa-push-test",data:{url:"/"}}),{TTL:120,urgency:"high",topic:"navixa-test"});
