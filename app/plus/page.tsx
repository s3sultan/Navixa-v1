...
export default function NavixaPlusPage() {
  return <main className="plus-page plus-simple" dir={languageIdentity.ar.direction}>
    ...
    <section className="plus-hero" aria-labelledby="plus-title"><div className="plus-hero-copy"><span className="plus-eyebrow">NAVIXA Plus · شهر كامل</span><h1 id="plus-title">خلّ NAVIXA<br /><strong>ينتبه معك.</strong></h1><p>الباقة الكاملة للاستخدام المستمر في الدراسة والعمل والاجتماعات، مع أدوات الانتباه والمتابعة والملخصات لمدة شهر.</p><div className="plus-hero-actions"><a href="#interest" className="primary">أبلغني عند فتح Plus</a><a href="#included" className="ghost">شاهد ما يشمله Plus</a><Link className="ghost" href="/sprint">أحتاجه لخمسة أيام فقط</Link></div><div className="plus-trust"><span>✓ السعر الحالي 0 ر.س</span><span>✓ السعر القياسي 25 ر.س / شهر</span><span>✓ كمبيوتر + جوال</span></div></div><aside className="plus-preview" aria-label="لمحة عن تجربة Plus"><span className="preview-badge">مثال</span><div className="preview-screen"><div className="preview-dot" /><small>اجتماعك مستمر…</small><b>تم سماع اسمك</b><p>NAVIXA انتبه لك. ارجع للاجتماع الآن.</p><span className="preview-phone">إشعار على الجوال أيضًا</span></div></aside></section>
