  ...
  return <main className="plus-page" dir={languageIdentity.ar.direction}><ReferralCapture/>
    ...
    <section className="plus-plans" id="plans" aria-labelledby="plans-title">
      ...
      <div className="plan-grid">
        ...
        <article className="plan-card featured"><span className="plan-tag">عرض مؤسسي NAVIXA</span><h3>Plus الشهري</h3><div className="plan-price"><b>19</b><span>ر.س<br/>شهريًا</span></div><p>خصم مؤسس شخصي ومحدود، يظهر لك بوضوح قبل تأكيد الدفع.</p><a href="#checkout">اشترك مباشرة</a></article>
      ...
      <aside className="founders-note"><span>✦</span><p><b>عرض مؤسسي NAVIXA.</b> سعر مؤسس شخصي ومحدود، يظهر لك كاملًا قبل تأكيد الدفع.</p></aside>
    </section>
