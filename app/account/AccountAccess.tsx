...
export default function AccountAccess() {
  ...
  const openGoogleLoginOnMobile = () => {
    ...
    if (!google?.accounts?.id) { setNotice("جارٍ تجهيز Google؛ أعد المحاولة بعد لحظة."); return; }
