...
import { saveReviewedAcademicReminder } from "../academicReminderAutomation";
import "./meetings.css";
...
export default function MeetingStudio() {
  ...
  const acceptAcademicSuggestion = async (suggestion: AcademicSuggestion) => {
    ...
    await saveReviewedAcademicReminder({ title, date });
