...
export default function Home(){
  ...
  return <main className={`nx ${entered?"entered":"waiting"}`} dir="rtl">
    ...
    <section className="nx-page" id="top">
      ...
      <footer><div className="nx-brand"><span>ن</span><div><b>NAVIXA</b><small>ذكاء يفهم يومك</small></div></div><p>مصمم لحياة أكثر ترتيبًا للجميع.</p>{showCounter&&<div className="visit-counter"><small>مرات الدخول والتجربة</small><b>{visitCount.toLocaleString("en-US")}</b></div>}<span>© 2026 NAVIXA</span></footer>
    </section>
