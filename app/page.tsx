...
type HomeModal="tasks"|"ask"|"automation"|"screen"|"alerts"|"backup";
...
export default function Home(){
  ...
  return <main className={`nx ${entered?"entered":"waiting"}`} dir="rtl">
    ...
    <aside className="nx-side">
      ...
      <div className="side-quick"><small>أدوات سريعة</small><button onClick={()=>setModal("tasks")}>المهام</button><button onClick={()=>setModal("alerts")}>التنبيهات</button><button onClick={()=>setModal("backup")}>البيانات</button></div>
