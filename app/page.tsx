...
import {isScreenEnabled,sendTelegramAlert,ALERT_TYPES,ALERT_LABELS,AlertType,getUserPrefs,setUserPrefs} from "./alertPrefs";
  ...
  return <main className={`nx ${entered?"entered":"waiting"}`} dir="rtl">
    ...
    <aside className="nx-side">
      ...
      <nav>
        ...
        <button onClick={()=>{setAlertPrefsState(getUserPrefs());setModal("alerts")}}><i>🔔</i> تنبيهاتي</button>
      </nav>
