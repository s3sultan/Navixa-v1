...
import PlanBadgeLinker from "./PlanBadgeLinker";
import "./globals.css";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ar" dir="rtl" suppressHydrationWarning><body><Script src="/navixa-appearance-bootstrap.js" strategy="beforeInteractive" /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} /><DirectEntry /><NavixaSplash /><PerformanceReporter /><PlanBadgeLinker />{children}<PricingHeaderShortcut /></body></html>;
}
