...
const initialCampaigns = [
  ...
  {name:"تحدي الحركة الأسبوعي",client:"خطوة",place:"الشريط الرئيسي",views:"96,810",clicks:"6.2%",budget:"2,450 ر.س",status:"نشطة",on:true,color:"blue"},
  {name:"اشتراك تنظيم المهام",client:"إنجاز",place:"صفحة التقارير",views:"41,950",clicks:"3.4%",budget:"1,180 ر.س",status:"مجدولة",on:false,color:"orange"},
  {name:"استشارة إنتاجية مجانية",client:"خبراء العمل",place:"مساعد NAVIXA",views:"28,610",clicks:"7.1%",budget:"950 ر.س",status:"مراجعة",on:false,color:"purple"},
];
...
export default function AdsPage(){
  ...
  return <main dir="rtl" className="ads-shell">
    ...
    <aside className="admin-side ads-side"><div className="logo"><span className="admin-logo-mark"><img src="/navixa-mark.png" alt="" /></span><div><b dir="ltr">NAVIXA <small className="brand-sa">SA</small></b><small>ADMIN CENTER</small></div></div><div className="admin-badge">لوحة الإدارة</div><nav><a href="/admin"><i>⌂</i>نظرة عامة</a><a href="/admin"><i>✦</i>المميزات</a><a href="/admin"><i>♙</i>المستخدمون</a><a href="/admin"><i>⌁</i>الأجهزة</a><a href="/admin"><i>⚙</i>الأتمتة</a><a className="on" href="/admin/ads"><i>▣</i>الإعلانات<em>4</em></a><a href="/admin"><i>!</i>التنبيهات</a><a href="/admin"><i>▤</i>سجل النظام</a></nav><div className="admin-side-bottom"><Link href="/">← العودة إلى NAVIXA</Link><div><span>م</span><p><b>محمد</b><small>مدير النظام</small></p></div></div></aside>
